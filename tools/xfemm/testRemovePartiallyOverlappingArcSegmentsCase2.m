...
% Arc 1
angleArc1 = 2*pi/3; % angle of arc 1 
angleRotate1 = 200*pi/180; % rotate arc by angleRotate1 counterclockwise
...
% Arc 2
angleArc2 = 90*pi/180; % angle of arc 2
angleRotate2 = 245*pi/180; % rotate arc by angleRotate2 counterclockwise
% Start and end node coordinates of the arc in the form of x + jy
