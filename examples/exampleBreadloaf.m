...
arc1 = CrossSectArc( ...
        ...
        'dim_alpha', DimDegree(30), ...
        'location', Location2D( ...
            'anchor_xy', DimMillimeter([14,3.5]), ...
            'rotate_xy', DimDegree(180) ...
        ) ...
        );
...
trap1 = CrossSectTrapezoid( ...
        ...
        'dim_theta', DimDegree(60), ...
        'dim_depth', DimMillimeter(1), ...
        'location', Location2D( ...
            'anchor_xy', DimMillimeter([2,-2]), ...
            'rotate_xy', DimDegree(135) ...
        ) ...
        );
...
bread1 = CrossSectBreadloaf( ...
        ...
        'location', Location2D( ...
            'anchor_xy', DimMillimeter([-3,3]), ...
            'rotate_xy', DimDegree(-45) ...
        ) ...
        );
    
%% Define components

cs = [arc1 trap1 bread1];
