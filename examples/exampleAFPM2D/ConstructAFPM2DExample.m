function [toolMn,coil_A,coil_B,coil_C] = ConstructAFPM2DExample(t_y, t_m, g, h, w_m, w_c, w, p, Q)
MES_Remesh = 2;
toolMn = MagNet();
...
CSmagnet1s = CrossSectSolidRect( ...
    ...
    compMag1s = Component( ...
        ...
        'material', MaterialGeneric('name', 'Recoma 33E'), ... %  Hiperco 50A 0.006 
        'makeSolid', MakeExtrude( ...
            'location', Location3D( ...
                'anchor_xyz', DimMillimeter([0,0,0]), ...
                'rotate_xyz', DimDegree([0,0,0]).toRadians() ...
    ...
    %mn_d_setparameter(toolMn.doc, compMag1s.name,'MaterialDirection',  ,get(toolMn.consts,'infoNumberParameter'));
    %mn_d_setparameter(toolMn.doc, compMag1s.name,'MaterialDirection(1)', -1 ,get(toolMn.consts,'infoNumberParameter'));
    %mn_d_setparameter(toolMn.doc, compMag1s.name,'MaterialDirection(2)', 0 ,get(toolMn.consts,'infoNumberParameter'));
    toolMn.viewAll();
...
for i = 1:Q
    ...
    compCoilIn(i) = Component( ...
        ...
        'material', MaterialGeneric('name', 'Copper: 5.77e7 Siemens/meter'), ... %  Hiperco 50A 0.006 
        'makeSolid', MakeExtrude( ...
            'location', Location3D( ...
                'anchor_xyz', DimMillimeter([0,0,0]), ...
                'rotate_xyz', DimDegree([0,0,0]).toRadians() ...
