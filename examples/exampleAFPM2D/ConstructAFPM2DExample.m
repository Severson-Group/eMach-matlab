...
% Stator VA
csStatorVA = CrossSectSolidRectangleangle( ...
        'name', 'csStatorVA', ...
...
csRotorAir1 = CrossSectSolidRectangleangle( ...
        'name', 'csRotorAir1', ...
        'dim_w',DimMillimeter(w_m*2*p),....
...
csRotor1VA = CrossSectSolidRectangleangle( ...
        'name', 'csRotor1VA', ...
        'dim_w',DimMillimeter(w_m*2*p),....
...
csRotor1Remesh = CrossSectSolidRectangleangle( ...
        'name', 'csRotor1Remesh', ...
        'dim_w',DimMillimeter(w_m*2*p),....
        'dim_h',DimMillimeter(g/4),...
        'location', Location2D( ...
...
csRotorAir2 = CrossSectSolidRectangleangle( ...
        'name', 'csRotorAir2', ...
        'dim_w',DimMillimeter(w_m*2*p),....
        'dim_h',DimMillimeter(t_y + t_m + 1),...
        'location', Location2D( ...
