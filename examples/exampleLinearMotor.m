...
magnet1 = CrossSectHollowRect( ...
        'name', 'magnet1', ...
        'dim_t1', DimMillimeter(0), ...
        'dim_t2', DimMillimeter(0), ...
        'dim_t3', DimMillimeter(0),...
        'dim_t4', DimMillimeter(0),...
...
% cs = [statorIron, moverIron];
cs = [statorIron, moverIron, magnet1, magnet2, magnet3];
