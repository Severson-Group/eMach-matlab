...
condL = Component( ...
        ...
        'material', MaterialGeneric('name', 'Name=Copper: 5.77e7 Siemens/meter'), ...
...
for i = 1:n
    ...
    compLam(i) = Component( ...
        ...
        'material', MaterialGeneric('name', 'Name=M19: USS Transformer 72 -- 29 Gage'), ...
        'makeSolid', MakeExtrude( ...
            'location', Location3D( ...
                'anchor_xyz', DimMillimeter([0,0,0]), ...
                'rotate_xyz', DimDegree([0,0,0]).toRadians() ...
